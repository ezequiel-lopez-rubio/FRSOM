...
S=PolSCENEAddBarrier(S,[-1,-1;3,-1;3,-3;-1,-3]);
...
Parameters.InitialLearningRate=0.6;
Parameters.MaxRadius=RowsCols/2;
Parameters.ConvergenceLearningRate=0.1;
Parameters.ConvergenceRadius=0.1;

%Create samples
NumSamples=1000;
SamplesX=[unifrnd(-0.5,0.5,1,500),4.+unifrnd(-0.5,0.5,1,500)];
SamplesY=unifrnd(-0.5,0.5,1,1000);
